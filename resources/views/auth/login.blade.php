...
<div class="login-box">
    ...
    <form method="POST" action="{{ route('admin.login.post') }}">
        ...
        <div class="form-group">
            ...
            @error('email')<p class="field-error"><i class="fas fa-exclamation-triangle" style="margin-left:4px"></i>{{ $message }}</p>@enderror
        </div>
        <div class="form-group">
            ...
            @error('password')<p class="field-error"><i class="fas fa-exclamation-triangle" style="margin-left:4px"></i>{{ $message }}</p>@enderror
            
            <div style="text-align:left;margin-top:0.6rem">
                <a href="{{ route('admin.password.request') }}" style="color:var(--text-muted);font-size:0.8rem;text-decoration:none;transition:color 0.2s;" onmouseover="this.style.color='var(--gold)'" onmouseout="this.style.color='var(--text-muted)'">نسيت كلمة المرور؟</a>
            </div>
        </div>
