    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        input {
            ...
            color:var(--text); font-family:'Cairo',sans-serif; font-size:1.5rem;
        ...
        .btn-verify:hover { transform:translateY(-1px); box-shadow:0 8px 20px rgba(201,168,76,0.3); }
    </style>
</head>
<body>
<div class="login-box">
    ...
    <h1>تحقق من الرمز</h1>
    <p class="subtitle">أدخل الرمز المكون من 6 أرقام للتحقق</p>
    ...
    <div style="background:rgba(239,68,68,0.1); border:1px solid rgba(239,68,68,0.3); color:#fca5a5; padding:0.8rem 1rem; border-radius:10px; font-size:0.88rem; margin-bottom:1.5rem;">
        <?php echo e(session('error')); ?>

    </div>
    <?php endif; ?>

    <form method="POST" action="<?php echo e(route('admin.password.verify.post')); ?>">
        <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?><p style="color:#fca5a5; font-size:0.8rem; margin-top:0.3rem;"><?php echo e($message); ?></p><?php unset($message);
...
<?php /**PATH E:\PHP\masoung-laravel\masoung\resources\views/auth/verify_code.blade.php ENDPATH**/ ?>