...
<div class="login-box">
    ...
    <form method="POST" action="<?php echo e(route('admin.password.update.reset')); ?>">
        <?php echo csrf_field(); ?>
...
<?php /**PATH E:\PHP\masoung-laravel\masoung\resources\views/auth/new_password.blade.php ENDPATH**/ ?>