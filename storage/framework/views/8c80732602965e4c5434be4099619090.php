...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'لوحة التحكم'); ?> | إدارة قبيلة مسونق</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <nav>
        ...
        <a href="<?php echo e(route('admin.members')); ?>" class="<?php echo e(request()->routeIs('admin.members*') ? 'active' : ''); ?>">
            <i class="fas fa-users"></i> الأعضاء
        </a>
        <?php endif; ?>
        <?php if($isSuper || in_array('manage_activities', $perms)): ?>
        <a href="<?php echo e(route('admin.activities')); ?>" class="<?php echo e(request()->routeIs('admin.activities*') ? 'active' : ''); ?>">
    ...
    <?php if($loggedAdmin && $loggedAdmin->role === 'super_admin'): ?>
    ...
    <nav>
        ...
        <a href="<?php echo e(route('admin.logs')); ?>" class="<?php echo e(request()->routeIs('admin.logs*') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-foot">
        <div class="admin-info">
            مرحباً،
            <span><?php echo e(session('admin_name', 'المدير')); ?></span>
        </div>
...
<?php /**PATH E:\PHP\masoung-laravel\masoung\resources\views/layouts/admin.blade.php ENDPATH**/ ?>