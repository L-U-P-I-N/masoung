...
<div class="login-box">
    ...
    <form method="POST" action="<?php echo e(route('admin.password.email')); ?>">
        ...
        <div class="form-group">
            ...
            <input type="email" id="email" name="email" placeholder="admin@example.com" required value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <a href="<?php echo e(route('admin.login')); ?>" class="back-login">
...
<?php /**PATH E:\PHP\masoung-laravel\masoung\resources\views/auth/forgot_password.blade.php ENDPATH**/ ?>