<?php $__env->startSection('title', $activity ? 'تعديل نشاط' : 'إضافة نشاط'); ?>
<?php $__env->startSection('page-title', $activity ? 'تعديل النشاط' : 'إضافة نشاط جديد'); ?>
<?php $__env->startSection('breadcrumb', 'الرئيسية / الأنشطة / ' . ($activity ? 'تعديل' : 'إضافة')); ?>

<?php $__env->startSection('topbar-actions'); ?>
    <a href="<?php echo e(route('admin.activities')); ?>" class="btn btn-edit">
...
<form method="POST"
    action="<?php echo e($activity ? route('admin.activities.update', $activity->id) : route('admin.activities.store')); ?>"
    ...
    <div class="form-card">
        <div class="form-grid">
            ...
            <div class="form-group full">
                ...
                <input type="text" name="title" value="<?php echo e(old('title', $activity->title ?? '')); ?>" placeholder="أدخل عنوان النشاط" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="date" name="activity_date" value="<?php echo e(old('activity_date', $activity->activity_date ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="location" value="<?php echo e(old('location', $activity->location ?? '')); ?>" placeholder="مثال: قاعة الاحتفالات، المنطقة الشرقية...">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group full">
                ...
                <?php if($activity && $activity->image): ?>
                    <?php $existingImages = array_filter(array_map('trim', explode(',', $activity->image))); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group full">
                ...
                <textarea name="description" placeholder="وصف مختصر يظهر في القوائم..." required><?php echo e(old('description', $activity->description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group full">
                ...
                <textarea name="content" style="min-height:200px" placeholder="محتوى تفصيلي كامل يظهر في صفحة النشاط..."><?php echo e(old('content', $activity->content ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <div class="toggle-wrap">
                    <input type="checkbox" id="is_published" name="is_published"
                        <?php echo e(old('is_published', $activity->is_published ?? true) ? 'checked' : ''); ?>>
        ...
        <div style="border-top:1px solid var(--border);margin-top:1.5rem;padding-top:1.5rem;display:flex;gap:1rem">
            <button type="submit" class="btn btn-primary" style="padding:0.75rem 2rem;font-size:0.95rem">
                ...
                <?php echo e($activity ? 'حفظ التعديلات' : 'إضافة النشاط'); ?>

            </button>
            <a href="<?php echo e(route('admin.activities')); ?>" class="btn btn-edit" style="padding:0.75rem 1.5rem">إلغاء</a>
        </div>
    </div>
</form>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PHP\masoung-laravel\masoung\resources\views/admin/activities/form.blade.php ENDPATH**/ ?>